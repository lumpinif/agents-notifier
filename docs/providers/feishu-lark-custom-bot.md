...
Avoid keyword security for Agents Notifier. A keyword rule can block normal notifications unless every message contains that keyword.

## 4. Connect Agents Notifier
